    ...
    navigator.getBattery().then((batt) => {
        updateBattery = () => {
            ...
            if(level <= 20) {
                ...
                batteryLiquid.classList.remove("gradient-color-orange", "grandient-color-yellow", "grandient-color-green")
            }

            else if(level <= 40) {
                batteryLiquid.classList.add("gradient-color-orange")
                batteryLiquid.classList.remove("gradient-color-red", "grandient-color-yellow", "grandient-color-green")
            }

            else if(level <= 80) {
                batteryLiquid.classList.add("gradient-color-yellow")
                batteryLiquid.classList.remove("gradient-color-red", "grandient-color-orange", "grandient-color-green")
            }

            else {
                batteryLiquid.classList.add("gradient-color-green")
                batteryLiquid.classList.remove("gradient-color-red", "grandient-color-yellow", "grandient-color-orange")
            }
        }
